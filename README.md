...
<details>
<summary>🌷 Завдання 5 (06.03.26)</summary>
<br>

> 💻 У цьому завданні реалізовано обробку колекцій з використанням шаблонів Command, Singleton та макрокоманди Menu. Додано підтримку скасування операцій (undo).

🔗 [Перейти до завдання](https://github.com/Vumirka/oop-java-practice/tree/task-5-(06.03.26))

</details>

<details>
<summary>🌷 Завдання 6 (09.03.26)</summary>
<br>

> 💻 У цьому завданні реалізовано паралельну обробку колекції з використанням шаблону Worker Thread. Два обробники черги виконують три завдання паралельно — пошук мінімуму, максимуму та середнього значення R_total.

🔗 [Перейти до завдання](https://github.com/Vumirka/oop-java-practice/tree/task-6-(09.03.26))

</details>

<details>
<summary>🌷 Завдання 7 (18.03.26)</summary>
<br>

> 💻 У цьому завданні розроблено графічний інтерфейс з використанням шаблону Observer, анотацій з різними Retention policies та рефлексії. Три спостерігачі автоматично оновлюють таблицю, графіки та статистику при кожній зміні колекції.

🔗 [Перейти до завдання](https://github.com/Vumirka/oop-java-practice/tree/task-7-(18.03.26))
